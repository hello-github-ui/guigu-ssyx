<template>
    <div class="app-container">
        ...
        <el-card class="operate-container" shadow="never">
            ...
            <el-button :disabled="$hasBP('btn.all')  === false" class="btn-add" size="mini" @click="addSku()">添加
            </el-button>
        ...
        <el-table
            ...
            <el-table-column label="商品名称" prop="skuInfo.skuName"/>
            <el-table-column label="商品编号" prop="skuInfo.skuCode"/>
            <el-table-column label="商品价格" prop="skuInfo.price"/>
            <el-table-column label="剩余数量" prop="skuInfo.stock"/>
            <el-table-column label="秒杀价格" prop="seckillPrice"/>
            <el-table-column label="秒杀数量" prop="seckillStock"/>
            ...
            <el-table-column align="center" label="操作" width="200">
                <template slot-scope="scope">
                    <el-button :disabled="$hasBP('btn.all')  === false" type="text" @click="handleUpdate(scope.row)">
                        修改
                    </el-button>
                    <el-button :disabled="$hasBP('btn.all')  === false" type="text"
        ...
        <el-dialog :visible.sync="selectDialogVisible" title="添加商品" width="40%">
