<template>
    <div class="app-container">
        ...
        <h4>
            规则列表&nbsp;&nbsp;&nbsp;
            <el-button size="mini" type="" @click="dialogRuleVisible = true">添加规则</el-button>
        </h4>
        <el-table
            ...
            <el-table-column v-if="activityInfo.activityType == 'FULL_REDUCTION'" label="满减金额"
                             prop="conditionAmount"/>
            <el-table-column v-if="activityInfo.activityType == 'FULL_REDUCTION'" label="优惠金额"
                             prop="benefitAmount"/>

            <el-table-column v-if="activityInfo.activityType == 'FULL_DISCOUNT'" label="满减量数" prop="conditionNum"/>
            <el-table-column v-if="activityInfo.activityType == 'FULL_DISCOUNT'" label="优惠折扣"
                             prop="benefitDiscount"/>

            <el-table-column align="center" label="操作" width="200">
                <template slot-scope="scope">
                    <el-button size="mini" type="text" @click="removeDataById(scope.$index)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <h4>
            活动范围列表&nbsp;&nbsp;&nbsp;
            <el-button size="mini" type="" @click="dialogRangVisible = true">添加活动范围</el-button>
        </h4>
        <el-table
            v-loading="listLoading"
            :data="skuInfoList"
            ...
            <el-table-column label="SKU ID" prop="id" width="100"/>
            <el-table-column align="center" label="图片" width="320">
                <template slot-scope="scope">
                    <div class="info">
                        <div class="pic">
            ...
            <el-table-column align="center" label="操作" width="200">
                <template slot-scope="scope">
                    <el-button size="mini" type="text" @click="removeSkuDataById(scope.$index)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
