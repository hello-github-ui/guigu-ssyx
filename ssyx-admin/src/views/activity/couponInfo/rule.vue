<template>
    <div class="app-container">
        ...
        <el-form label-width="0px"
                 style="background: #f9f9f9;padding-top: 15px;padding-left: 15px; padding-bottom: 1px;">
            <el-form-item>
        ...
        <div v-if="couponInfo.rangeType == 'SKU'">
            <el-dialog :visible.sync="dialogSkduRangVisible" title="添加范围" width="490px">
            ...
            <h4>
                优惠券范围列表&nbsp;&nbsp;&nbsp;
                <el-button size="mini" type="" @click="dialogSkduRangVisible = true">添加优惠券范围</el-button>
            </h4>
            <el-table
        ...
        <div v-if="couponInfo.rangeType == 'CATEGORY'">
            ...
            <h4>
                优惠券范围列表&nbsp;&nbsp;&nbsp;
                <el-button size="mini" type="" @click="dialogCateRangVisible = true">添加优惠券范围</el-button>
            </h4>
            <el-table
                v-loading="listLoading"
                :data="categoryList"
