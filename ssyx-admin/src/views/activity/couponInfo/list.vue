<template>
    <div class="app-container">
        ...
        <el-table
            ...
            <el-table-column label="购物券名称" prop="couponName"/>
            <el-table-column label="购物券类型" prop="couponTypeString"/>
            ...
            <el-table-column label="范围类型 " prop="rangeTypeString"/>
            <el-table-column label="发行数量" prop="publishCount"/>
