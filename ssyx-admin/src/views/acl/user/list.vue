<template>
    <div class="app-container">
            ...
            <div style="margin-top: 15px">
                <el-form :inline="true" label-width="140px" size="small">
                    <el-form-item label="输入搜索：">
                        <el-input v-model="tempSearchObj.username" placeholder="用户名" style="width: 203px"></el-input>
                    </el-form-item>
        ...
        <el-card class="operate-container" shadow="never">
            ...
            <el-button :disabled="selectedIds.length===0" class="btn-add" size="mini" style="margin: 0 10px;"
        ...
        <el-table
            ...
            <el-table-column align="center" label="操作" width="220">
                ...
                <template slot-scope="scope">
                    <el-button size="mini" type="text" @click="showAssignRole(scope.row)">分配角色</el-button>
                    <el-button size="mini" type="text" @click="showUpdateUser(scope.row)">修改</el-button>
                    <el-button size="mini" type="text" @click="removeUser(scope.row.id)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog :before-close="resetRoleData" :visible.sync="dialogRoleVisible" title="设置角色">
